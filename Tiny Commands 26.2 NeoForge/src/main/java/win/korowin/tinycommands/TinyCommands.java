...
@Mod(value = TinyCommands.MODID, dist = Dist.CLIENT)
public class TinyCommands {
    ...
    public TinyCommands(IEventBus modEventBus, ModContainer modContainer) {
        ...
        modContainer.registerExtensionPoint(IConfigScreenFactory.class,
                (client, parent) -> AutoConfigClient.getConfigScreen(Config.class, parent).get()
        );
    }
    ...
    public void onRegisterClientCommands(RegisterClientCommandsEvent event) {
        ...
        if (config.enableNightVisionCommand) {
            dispatcher.register(Commands.literal("nv").executes(context -> {
        ...
        if (config.enableEffectClearCommand) {
            dispatcher.register(Commands.literal("eclear").executes(context -> {
