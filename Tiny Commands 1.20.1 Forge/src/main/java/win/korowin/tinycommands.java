...
/**
 * Main entry point for Tiny Commands mod (Forge).
 * Handles registration of short versions of standard Minecraft commands.
 */
...
public class tinycommands {
    ...
    public tinycommands() {
        ...
        // Register the client command event on the Forge event bus
        MinecraftForge.EVENT_BUS.register(this);

        // Register Config Screen for Forge
        ModLoadingContext.get().registerExtensionPoint(ConfigScreenHandler.ConfigScreenFactory.class, 
            () -> new ConfigScreenHandler.ConfigScreenFactory((client, parent) -> 
                AutoConfig.getConfigScreen(TinyCommandsConfig.class, parent).get()
            )
        );
    }
    ...
    /**
     * Event listener for registering client-side commands in Forge.
     */
    @SubscribeEvent
